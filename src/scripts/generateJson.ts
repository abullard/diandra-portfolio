...
export const generateJson = async () => {
    const photographyContents = await fileSystemService.readdirAsync(PHOTOGRAPHY_DIR);
    const architectureContents = await fileSystemService.readdirAsync(ARCHITECTURE_DIR);
