...
const PhotographyLink = () => {
    ...
    const [imgOneSource, setImgOneSource] = useState<string>(HOME_LIGHTENED_PHOTO);
    const [imgTwoSource, setImgTwoSource] = useState<string>(OFFICE_LIGHTENED_PHOTO);
    ...
    return (
        <Link to="photography" aria-label="go-to-photography">
            <PhotographyImageContainer onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
